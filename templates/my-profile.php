                                    ...
                                    <div class="col-lg-5 col-md-6">
                                        <div class="card card-block card-stretch card-height">
                                            <div class="card-header">
                                                <div class="header-title">
                                                    <h4 class="card-title">پادکست های مناسب شما </h4>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                <ul class="list-inline p-0 m-0 rtl-text">
                                                    <li class="d-flex align-items-center mb-3">
                                                        ...
                                                        <div class="pl-3 rtl-pr-3 rtl-pl-0">
                                                            <h5>فایل شماره 1</h5>
                                                            <p class="mb-0">توضیحات فایل </p>
                                                        </div>
                                                    </li>
                                                    <li class="d-flex align-items-center mb-3">
                                                        ...
                                                        <div class="pl-3 rtl-pr-3 rtl-pl-0">
                                                            <h5>فایل شماره 2</h5>
                                                            <p class="mb-0">توضیحات فایل شماره 2</p>
                                                        </div>
                                                    </li>
                                                    <li class="d-flex align-items-center mb-3">
                                                    ...
                                                    <li class="d-flex align-items-center mb-3">
                                                        <div class="profile-icon iq-icon-box rounded-small bg-danger-light svg-success text-center">
                                                            <svg width="24" height="20" viewBox="0 0 24 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <g clip-path="url(#clip0)">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="card card-block card-stretch card-height">
                                                    <div class="card-header">
                                                        <div class="header-title">
                                                            <h4 class="card-title">آخرین فایل های آپلودی</h4>
                                                        </div>
                                                    </div>
                                                    <div class="card-body">
                                                        <ul class="list-inline p-0 m-0 rtl-text">
                                            ...
                                            <div class="col-md-12 col-lg-6">
                                                <div class="card card-block card-stretch card-height">
                                                    <div class="card-header">
                                                        <div class="header-title">
                                                            <h4 class="card-title">پیشنهادات و انتقادات شما</h4>
                                                        </div>
                                                    </div>
                                                    <div class="card-body">
                                                        <ul class="list-inline mb-0 p-0">
                                                            <li class="d-flex align-items-center mb-2">
                                                                <span class="bg-info-light rounded-small iq-card-icon-small mr-3 rtl-ml-3 rtl-mr-0">1</span>
                                                                <p class="mb-0 font-size-16 "> شماره 1</p>
                                                            </li>
                                                            <li class="d-flex align-items-center mb-2">
                                                                <span class="bg-warning-light rounded-small iq-card-icon-small mr-3 rtl-ml-3 rtl-mr-0">2</span>
                                                                <p class="mb-0 font-size-16 ">تایتل شماره 2</p>
                                                            </li>
                                                            <li class="d-flex align-items-center">
                                                                <span class="bg-danger-light rounded-small iq-card-icon-small mr-3 rtl-ml-3 rtl-mr-0">3</span>
                                                                <p class="mb-0 font-size-16 ">تایتل شماره 3</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6">
                                        <div class="card card-block card-stretch card-height">
                                            <div class="card-body text-center">
                                                ...
                                                <h2 class="mb-2 mt-3 text-success">مهارت </h2>
                                                <h4>پیشنهاد</h4>
                                            </div>
                                        </div>
                                    </div>
